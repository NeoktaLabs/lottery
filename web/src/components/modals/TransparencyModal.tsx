...
import { X, ExternalLink, ShieldCheck, Database, FileCode, Factory } from 'lucide-react';
...
export function TransparencyModal({ isOpen, onClose, raffleAddress, deployerAddress }: TransparencyModalProps) {
