      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-fade-in-up">
        ...
        <div className="bg-gray-900 p-5 text-white flex justify-between items-center">
          <h3 className="font-black text-lg flex items-center gap-2">
            <FileCode size={20} className="text-gray-400" /> Contract Details
          </h3>
        ...
        <div className="p-6 space-y-6">
          ...
          {isOfficial ? (
            <div className="bg-green-50 border border-green-100 p-4 rounded-2xl flex gap-3">
              ...
              <div>
                <h4 className="font-bold text-green-900 text-sm">Official Verified Raffle</h4>
                <p className="text-xs text-green-700/80 mt-1 leading-relaxed">
                  This raffle was created by the official Ppopgi System. The rules are immutable and the drawing is verifiably random.
                </p>
              </div>
            </div>
          ) : (
            <div className="bg-amber-50 border border-amber-100 p-4 rounded-2xl flex gap-3">
              ...
              <div>
                <h4 className="font-bold text-amber-900 text-sm">Community Raffle</h4>
                <p className="text-xs text-amber-700/80 mt-1 leading-relaxed">
                  This raffle was created by a community member. Always check the parameters before playing.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl border border-gray-100">
              <div className="flex items-center gap-3">
                <div className="text-gray-400"><Coins size={16} /></div>
                <span className="text-sm font-bold text-gray-600">Protocol Fee</span>
              </div>
          ...
          <div className="text-center pt-2">
            <p className="text-[10px] text-gray-400">
              Ppopgi does not hold custody of your funds. <br/> All logic is executed on Etherlink.
            </p>
          </div>
